# This Makefile is for the lib/Finance/Optical/StrongBuy.pm extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Finance/Optical/StrongBuy.pm]
#     AUTHOR => q[hagen geissler <santex@cpan.org>]
#     BUILD_REQUIRES => {  }
#     NAME => q[lib/Finance/Optical/StrongBuy.pm]
#     PREREQ_PM => { Data::Dumper=>q[0], WWW::Mechanize=>q[0], GD=>q[0], GD::Image=>q[0], Carp=>q[0] }
#     VERSION_FROM => q[lib/Finance/Optical/StrongBuy.pm]
...
NAME_SYM = lib_Finance_Optical_StrongBuy_pm
VERSION = 0.01
...
MAKE = make
FULLEXT = lib/Finance/Optical/StrongBuy.pm
BASEEXT = pm
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Finance/Optical/StrongBuy.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTNAME = lib/Finance/Optical/StrongBuy.pm
DISTVNAME = lib/Finance/Optical/StrongBuy.pm-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               lib/Finance/Optical/StrongBuy.pm' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="GD::" />' >> $(DISTNAME).ppd
